...
- [`ui-design-proposal-template.html`](ui-design-proposal-template.html): first-class inspectable UI design proposal with product/surface routing, design-basis preflight, user decisions, 3-4 materially comparable direction frames when needed, chosen desktop/mobile proof, hierarchy and taste contracts, evidence expectations, and open tensions. Card/list and drawer/sidebar/bottom-sheet sections are conditional selected-pattern contracts, not universal composition defaults.
