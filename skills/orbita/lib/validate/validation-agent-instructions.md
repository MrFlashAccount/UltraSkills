...
2. Inspect the workflow under review, usually `workflows/spdd/workflow.toml` or a checked-in `workflow.toml`.
...
- Confirm SPDD-specific policy stays in SPDD schemas/prompts, not generic workflow runtime code.
