...
- `roles/dev-rel` or `workflows/devrel-copywriter`: developer-facing README entrypoints, technical launch framing, repo-first product positioning, and developer-trust messaging
- `roles/tech-writer` or `workflows/docs-writer`: setup, onboarding, migration, usage, reference docs, and other success-through-explanation work
