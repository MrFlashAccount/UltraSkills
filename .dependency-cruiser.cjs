  ...
  forbidden: [
    {
      ...
      to: {
        path: '^(?:skills/orbita/lib/call-functions/(?:execute|registry|openai|sh|js|js-worker|subprocess)[.]mjs$|skills/orbita/lib/(?:entrypoints|persistence|runner|use-cases)/|(?:node:)?(?:child_process|fs|path|url)(?:/|$))',
      },
    },
    {
    ...
    },
    {
      ...
      to: { path: '^skills/orbita/lib/call-functions/(?:execute|registry|openai|sh|js|js-worker|subprocess)[.]mjs$' },
    },
    {
