...
- lightweight TDD and parallel driver/navigator workflow proposal -> [`workflows/LIGHTWEIGHT_ENGINEERING_WORKFLOWS.md`](workflows/LIGHTWEIGHT_ENGINEERING_WORKFLOWS.md)
